...
}(this, (function (exports,_rrule) { 'use strict';

_rrule = _rrule && 'default' in _rrule ? _rrule['default'] : _rrule;
...
ToText.IMPLEMENTED = [];
ToText.IMPLEMENTED[RRule$1.HOURLY] = common;
ToText.IMPLEMENTED[RRule$1.DAILY] = ['byhour'].concat(common);
ToText.IMPLEMENTED[RRule$1.WEEKLY] = common;
ToText.IMPLEMENTED[RRule$1.MONTHLY] = common;
ToText.IMPLEMENTED[RRule$1.YEARLY] = ['byweekno', 'byyearday'].concat(common);
