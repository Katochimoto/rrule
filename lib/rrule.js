...
;(function (root, factory) {
  ...
  dateutil.DateTime = function (...args) {
    this._date = new (Function.prototype.bind.apply(Date, [null].concat(args)))();
  };
  ...
  ['getFullYear', 'getMonth', 'getDate', 'getTimezoneOffset', 'getTime', 'getHours', 'getMinutes', 'getSeconds', 'getDay', 'toString', 'valueOf', 'getUTCFullYear', 'getUTCMonth', 'getUTCDate', 'getUTCHours', 'getUTCMinutes', 'getUTCSeconds'].forEach(function (name) {
  ...
  dateutil.DateTime.parse = function (...args) {
    return Date.parse.apply(Date, args);
  };
