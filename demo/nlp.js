...
exports.defineNlp = defineNlp;

var _ToText = __webpack_require__(14);
...
function defineNlp(RRule) {
  var ToText = (0, _ToText.defineToText)(RRule);
  ...
  function parseText(text, language) {
    var options = {};
    var ttr = new _Parser2.default((language || _constant.ENGLISH).tokens);
  ...
  return {
    fromText: fromText,
    parseText: parseText,
    isFullyConvertibleToText: isFullyConvertibleToText,
    toText: toText
  };
} /**
...
exports.defineToText = defineToText;
...
function defineToText(RRule) {
  ...
  function ToText(rrule, gettext, language) {
    this.text = '';
    this.language = language || _constant.ENGLISH;
